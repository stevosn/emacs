...
#+END_SRC
* csv
#+BEGIN_SRC(require-package 'csv-mode)
...
#+END_SRC
* recentf
#+BEGIN_SRC(add-hook 'after-init-hook 'recentf-mode)
(setq-default
...
#+END_SRC
* fci
#+BEGIN_SRC;; Fill column indicator
...
#+END_SRC
* neotree
#+BEGIN_SRC(require-package 'neotree)
(global-set-key [f8] 'neotree-toggle)
(global-set-key [f9] 'neotree-dir)

#+END_SRC
* ibuffer
#+BEGIN_SRC;; TODO: enhance ibuffer-fontification-alist
...
#+END_SRC
* smex
#+BEGIN_SRC;; Use smex to handle M-x
...
#+END_SRC
* flycheck
#+BEGIN_SRC(when (maybe-require-package 'flycheck)
...
#+END_SRC
* projectile
#+BEGIN_SRC(when (maybe-require-package 'projectile)
...
#+END_SRC
* themes
#+BEGIN_SRC;; (require-package 'color-theme-sanityinc-solarized)
...
#+END_SRC
* editing-utils
#+BEGIN_SRC(require-package 'unfill)
...
#+END_SRC
* utils
#+BEGIN_SRC(if (fboundp 'with-eval-after-load)
...
#+END_SRC
* auctex
#+BEGIN_SRC;;;; some AUCTeX tweaks from and other
...
#+END_SRC
* whitespace
#+BEGIN_SRC(setq-default show-trailing-whitespace t)
...
#+END_SRC
* vc
#+BEGIN_SRC(when (maybe-require-package 'diff-hl)
...
#+END_SRC
* benchmarking
#+BEGIN_SRC(defun sanityinc/time-subtract-millis (b a)
...
#+END_SRC
* git
#+BEGIN_SRC;; TODO: link commits from vc-log to magit-show-commit
;; TODO: smerge-mode
...
#+END_SRC
* code
#+BEGIN_SRC(require-package 'code-library)
...
#+END_SRC
* markdown
#+BEGIN_SRC(when (maybe-require-package 'markdown-mode)
...
#+END_SRC
* preload-local
#+BEGIN_SRC;; line number configuration
...
#+END_SRC
* python-mode
#+BEGIN_SRC;;; Basic python mode configuration
...
#+END_SRC
* company
#+BEGIN_SRC;; TODO Default sort order should place [a-z] before punctuation
...
with open('collected.org', 'w') as fl:
         for ifl in onlyfiles:
             with open(join(directory, ifl), 'r') as init_fl:
                 lines = init_fl.readlines()
                 fl.write(''.join([ifl.replace('init-', '* ').replace('.el', ''), '\n']))
                 fl.write('#+BEGIN_SRC')
                 for line in lines:
                     if not line.startswith('(provide'):
                         fl.write(line)
                 fl.write('#+END_SRC\n')
