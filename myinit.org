...
#+BEGIN_SRC emacs-lisp
  ...
  (setq org-todo-keywords
        (quote ((sequence "TODO(t)" "NEXT(x)" "|" "DONE(d!)" "CANCELLED(!)")
                ...
                (sequence "FEEDBACK DUE(f!)" "HOLD(h!)" "|" "DONE(d!)" "DELEGATED(e!@)" "CANCELLED(!)")))
  ...
  (setq org-todo-keyword-faces
        (quote (("TODO" :foreground "MediumSeaGreen" :weight bold :underline t)
                ("NEXT" :foreground "MediumSeaGreen" :weight bold :underline t)
                ...
                ("FEEDBACK DUE" :foreground "MediumSeaGreen" :weight bold :underline t)
                ("HOLD" :foreground "forestgreen" :weight bold :underline t)
                ("DELEGATED" :foreground "forestgreen" :weight bold :underline t)
                )))
